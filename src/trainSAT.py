...
# --- Define Paths, se realizan experimentos de mlflow ---
...
experiment_name = "Proyecto-FinalCICD"
...
# Contruimos el parametro que nos ayudara a copilar el modelo segun el nivel de desbalanceo de las categorias
